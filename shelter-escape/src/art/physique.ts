...
const P: Record<Stage, Physique> = {
  1: {
    ...
    weightKg: 62,
    bmi: 22.8,
    note: '標準。バスト88 / ウエスト64 / ヒップ106。肩より骨盤がわずかに広い。手足は細い。',
    cheek: 0.95,
    jowl: 0,
    neckHalf: 23,
    neckSink: 0,
  ...
  2: {
    ...
    weightKg: 78,
    bmi: 28.7,
    note: 'ふくよか。バスト98 / ウエスト77 / ヒップ120。殿部と大腿から先に増える。腹はまだ平ら。',
    cheek: 1.08,
    jowl: 0.12,
    neckHalf: 25,
    neckSink: 1,
  ...
  3: {
    ...
    weightKg: 95,
    bmi: 34.9,
    note: '肥満。バスト108 / ウエスト92 / ヒップ136。大腿が接し、下腹が丸みを持つ。上着は閉まるが引き攣る。',
    cheek: 1.2,
    jowl: 0.35,
    neckHalf: 27.5,
    neckSink: 3,
